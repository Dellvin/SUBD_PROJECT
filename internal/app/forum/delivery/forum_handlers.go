...
import (
	"SUBD_PROJECT/internal/app/forum/Model"
	"SUBD_PROJECT/internal/app/forum/Repository"
	"SUBD_PROJECT/internal/app/user"
	"SUBD_PROJECT/internal/pkg/GetValue"
	"SUBD_PROJECT/internal/pkg/resp"
	"database/sql"
	"encoding/json"
	"fmt"
...
func (f *forumHandler) CreateThread(ctx *fasthttp.RequestCtx) {
	...
	//ans:=Model.ThreadAns{
	//	Author: threadNew.Author,
	//	Title: threadNew.Title,
	//	Created: threadNew.Created,
	//	Forum: threadNew.Forum,
	//	Id: threadNew.Id,
	//	Message: threadNew.Message,
	//	Slug: threadNew.Slug.String,
	//	Votes: threadNew.Votes,
	//}
